...
def test_parameters_with_anyof_schema():
    ...
    assert data_property["anyOf"] == [
        {"type": "string"},
        {'type': 'object', 'propertyNames': {'type': 'string'}, 'additionalProperties': {'type': 'object', 'properties': {}, 'additionalProperties': False}}
    ]
...
def test_complex_nested_schema():
    ...
    assert inner_properties["simple_param"] == {"title": "Simple Param", "type": "string", "description": "A simple string parameter"}
    assert inner_properties["array_param"] == {"title": "Array Param", "type": "array", "items": {"type": "integer"}, "description": "An array of integers"}
    assert inner_properties["object_param"] == {"title": "Object Param", "type": "object", "description": "An object parameter", "additionalProperties": True}
    assert inner_properties["nested_param"] == {"title": "NestedParam", "type": "object", 'properties': {'nested_field': {'title': 'Nested Field', 'type': 'boolean'}}, "required": ["nested_field"]}
